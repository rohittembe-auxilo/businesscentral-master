table 50136 "G/L Acc. Budget Buffer Archive"
{
    Caption = 'G/L Acc. Budget Buffer Archive';
    ...
    fields
    {
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum("G/L Budget Entry Archive".Amount WHERE("Budget Name" = FIELD("Budget Filter"),
                                                               "G/L Account No." = FIELD("G/L Account Filter"),
                                                                "Version No." = field("Version No. Filter"),
        ...
        field(16; "Version No. Filter"; integer)
        {
