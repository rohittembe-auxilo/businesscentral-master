...
table 50118 "Company Information2"
{
    ...
    fields
    {
        ...
        field(50000; "Corporate Email ID"; text[50])
        {
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateCity(var CompanyInformation: Record "Company Information2"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidatePostCode(var CompanyInformation: Record "Company Information2"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateShipToPostCode(var CompanyInformation: Record "Company Information2"; var IsHandled: Boolean)
    begin
    end;
}
