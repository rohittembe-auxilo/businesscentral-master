table 50134 "G/L Budget Entry Archive"
{
    Caption = 'G/L Budget Entry Archive';
    // DrillDownPageID = "G/L Budget Entries Archive";
    // LookupPageID = "G/L Budget Entries Archive";
    ...
    keys
    {
        ...
        key(Key7; "Budget Name", "Version No.", "G/L Account No.", Date)
        {
            SumIndexFields = Amount;
        }
        key(Key8; "Budget Name", "Version No.", "G/L Account No.", "Business Unit Code", "Global Dimension 1 Code", "Global Dimension 2 Code", "Budget Dimension 1 Code", "Budget Dimension 2 Code", "Budget Dimension 3 Code", "Budget Dimension 4 Code", Date)
        {
            SumIndexFields = Amount;
        }
        key(Key9; "Budget Name", "Version No.", "G/L Account No.", Description, Date)
        {
        }
        key(Key10; "G/L Account No.", Date, "Budget Name", "Dimension Set ID", "Version No.")
        {
            SumIndexFields = Amount;
        }
